...
import {
    GET_USER_DATA_BEGIN, GET_USER_DATA_SUCCESS, GET_ALL_USERS_SUCCESS, GET_AVAILABLE_SHIFTS, GET_AVAILABLE_SHIFTS_SUCCESS,
    GET_ALL_SHIFTS_FOR_DATE_SUCCESS, SAVE_USER_BATCH, SAVE_USER_BATCH_SUCCESS, SAVE_USER_SHIFTS_IN_RANGE,
    SAVE_USER_SUCCESS, SAVE_USER_IS_ADMIN_SUCCESS, GET_ALL_SHIFTS_FOR_MONTH_SUCCESS, DELETE_USERS_SUCCESS
} from './types'
...
function saveUserDataRange(shifts) {
    return dataMethods.saveShiftsInRange(shifts)
}
...
export function saveUserShiftsInRange(shifts) {
    return dispatch => {
        return saveUserDataRange(shifts)
    }
}
